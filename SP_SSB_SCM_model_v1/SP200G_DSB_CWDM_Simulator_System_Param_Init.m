...
% ParamLas.deltaF = [300,100,-100,-300]*1e9;
...
%         ParamPD.R_pin = 0.65; %[A/W]
        ParamPD.R_pin = mean(0.55 * ParamGen.q_electron./ParamLas.Photon_Energy); %[A/W]
    ...
    case 3
        ...
        ParamPD.R_pin = mean(ParamPD.R_pin);
...
ParamSys.Analog_Rate_beforeDeMux = 19e12;
% ParamSys.Analog_Rate_beforeDeMux = 250e9*32;
ParamSys.Analog_Rate_afterDeMux = 200e9;



% Vbias, Vpp, Vpi
ParamSys.Vbias_over_Vpi = 0.5;
ParamSys.Vpp_over_Vpi = 1; 
