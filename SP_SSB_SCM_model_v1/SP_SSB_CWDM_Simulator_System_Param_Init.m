...
ParamLas.Lambda_ref = 1.55e-6; % O band
...
%% VSB 
ParamVSB.Opt_Flt_Suppression_dB = 20;
ParamVSB.Opt_Flt_Slope_dBper10GHz = 11; % for case 2 linear filter 
...
ParamSys.Analog_Rate_beforeDeMux = 2000e9;
% ParamSys.Analog_Rate_beforeDeMux = 250e9*32;
ParamSys.Analog_Rate_afterDeMux = 100e9;
...
ParamRxDSP.numKKiter = 1; % for KK option 2 only
ParamRxDSP.FFT_size_ratio = 1; 
ParamRxDSP.LMS_linear_tap = 19;
